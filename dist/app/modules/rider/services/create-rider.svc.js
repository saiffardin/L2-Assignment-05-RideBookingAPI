...
const createRider = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (isUserExist) {
        throw new AppError_1.default(http_status_codes_1.default.BAD_REQUEST, "Rider Already Exist.");
    }
    const hashedPassword = yield bcryptjs_1.default.hash(password, Number(config_1.envVars.BCRYPT_SALT_ROUND));
    const user = yield rider_model_1.Rider.create(Object.assign(Object.assign({ email, password: hashedPassword }, rest), { isDeleted: false, accountStatus: constants_1.UserAccount.ACTIVE, isVerified: false, status: constants_1.UserStatus.ONLINE }));
